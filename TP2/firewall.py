# FIREWALL para a topologia topoTP2.py
...
class L3switch(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Cache de ARP
        self.cache_arp={"10.0.0.2":"00:00:00:00:00:02",
                        "10.0.0.3":"00:00:00:00:00:03",
                        "10.0.0.4":"00:00:00:00:00:04",
                        "10.0.3.2":"00:00:00:00:03:02",
                        "10.0.3.3":"00:00:00:00:03:03",
                        "10.0.3.4":"00:00:00:00:03:04",
                        "10.0.5.2":"00:00:00:00:05:02",
                        "10.0.5.3":"00:00:00:00:05:03",
                        "10.0.5.4":"00:00:00:00:05:04"}
    ...
    def handle_ipv4(self, datapath,in_port, pkt):
        ...
        if mac_dst:
            if(pkt_ipv4.proto == inet.IPPROTO_TCP):
                ...
                #---------------FIREWALL---------------
                targets = ['10.0.0.2', '10.0.3.4', '10.0.5.4']
                http_hosts = ['10.0.3.4', '10.0.5.4']
                
                if pkt_ipv4.src not in targets or pkt_ipv4.dst not in targets or (pkt_ipv4.src in http_hosts and pkt_tcp.dst_port != 5555) or (pkt_ipv4.src == '10.0.0.2' and pkt_tcp.src_port != 5555):
                    return
